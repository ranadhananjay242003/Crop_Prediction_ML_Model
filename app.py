...
def train_crop_model():
    ...
    try:
        ...
        # Save the model
        joblib.dump(model, 'crop_prediction_compressed.joblib')
        print("Model saved to 'crop_prediction_compressed.joblib'.")
...
def predict_crop(user_input):
    ...
    try:
        ...
        model = joblib.load('crop_prediction_compressed.joblib')
        ...
        print("Error: Model file 'crop_prediction_compressed.joblib' not found.")
